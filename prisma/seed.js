...
async function main() {
  ...
  const coachProfilesData = [
    ...
    {
      bio: "Vous accompagner vers un mode de vie sain avec bienveillance.",
      specialty: "Coach de vie globale",
      hourlyRate: 60,
      averageRating: 4.6,
    },
    {
      bio: "Préparation mentale pour les défis personnels.",
      specialty: "Coach mental engagé",
      hourlyRate: 65,
      averageRating: 4.8,
    },
    {
      bio: "Accompagnement diététique et rééquilibrage.",
      specialty: "Nutri-coach certifiée",
      hourlyRate: 55,
      averageRating: 4.9,
    },
    {
      bio: "Ateliers collectifs sur la force tranquille.",
      specialty: "Coach de groupes et retraites",
      hourlyRate: 35,
      averageRating: 5.0,
    },
  ];
    ...
    coaches.map((coach, index) =>
      prisma.coachProfile.create({
        data: {
          ...
          verified: true,
          // mark first coach as ambassador for testing and add placeholder stripeAccountId
          ambassador: index === 0,
          stripeAccountId: index === 0 ? "acct_test_ambassador" : null,
        },
      }),
    ),
  );
  ...
  const products = await Promise.all([
    prisma.shopProduct.create({
      data: {
        ...
        description:
          "Un coffret pour ralentir, respirer et retrouver votre calme. Lorem ipsum dolor sit amet.",
        price: 29,
        stockQuantity: 18,
    ...
    prisma.shopProduct.create({
      data: {
        name: "Lumière douce",
        description:
          "Un rituel lumineux pour vos soirées. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
        price: 42,
        stockQuantity: 12,
    ...
    prisma.shopProduct.create({
      data: {
        ...
        description:
          "Notes, intentions et gratitude au quotidien. Lorem ipsum dolor sit amet.",
        price: 18,
        stockQuantity: 25,
    ...
    prisma.shopProduct.create({
      data: {
        name: "Brume sérénité",
        description:
          "Une brume légère pour installer une ambiance apaisante. Lorem ipsum dolor sit amet.",
        price: 24,
        stockQuantity: 20,
    ...
    prisma.shopProduct.create({
      data: {
        name: "Trousse zen",
        description:
          "Le nécessaire pour une pause bien-être en déplacement. Lorem ipsum dolor sit amet.",
        price: 36,
        stockQuantity: 14,
    ...
    prisma.shopProduct.create({
      data: {
        ...
        description:
          "Le kit idéal pour apaiser le rythme avant de dormir. Lorem ipsum dolor sit amet.",
        price: 31,
        stockQuantity: 16,
  ...
  // create a supplier user and link to first product for testing
  const supplierUser = await prisma.user.create({
    data: {
      firstName: "Supplier",
      lastName: "One",
      email: "supplier@sorea.local",
      password: coachPassword,
      role: "supplier",
      avatarUrl: "/uploads/coaches/supplier.png",
      isActive: true,
    },
  });
  ...
  const supplierProfile = await prisma.supplier.create({
    data: {
      ...
      companyName: "Sorea Supplies",
      contactEmail: "supplier@sorea.local",
      stripeAccountId: "acct_test_supplier",
    },
  });

  // attach first product to supplier
  await prisma.shopProduct.update({
    where: { id: products[0].id },
    data: { supplierId: supplierProfile.id },
  });
  ...
  const sessions = await Promise.all([
    prisma.coachSession.create({
      data: {
        ...
        description:
          "Une séance enveloppante pour relâcher les tensions et réveiller le corps. Lorem ipsum dolor sit amet.",
        sessionType: "Pilates",
    ...
    prisma.coachSession.create({
      data: {
        ...
        description:
          "Un temps calme pour retrouver de la clarté et du souffle. Lorem ipsum dolor sit amet.",
    ...
    prisma.coachSession.create({
      data: {
        ...
        description:
          "Écriture guidée pour poser ses pensées et avancer plus sereinement. Lorem ipsum dolor sit amet.",
    ...
    data: [
      {
        ...
        rating: 5,
        reviewText:
          "Très bonne énergie, séance ultra apaisante. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
      },
      {
        coachId: coachProfiles[1].id,
        userId: admin.id,
        rating: 4.8,
        reviewText:
          "Un accompagnement clair et doux. Lorem ipsum dolor sit amet.",
      },
    ],
  });
    ...
    data: [
      {
        ...
        rating: 5,
        reviewText:
          "Parfait pour décompresser après une journée chargée. Lorem ipsum dolor sit amet.",
      },
      {
    ...
    data: [
      {
        ...
        userId: admin.id,
        commentText:
          "À tester absolument pour le soir. Lorem ipsum dolor sit amet.",
      },
      {
        coachId: coachProfiles[2].id,
        userId: admin.id,
        commentText:
          "Super concept, très doux et inspirant. Lorem ipsum dolor sit amet.",
      },
    ],
  });
    ...
    data: [
      {
        ...
        userId: admin.id,
        commentText:
          "Le format est parfait pour progresser sans pression. Lorem ipsum dolor sit amet.",
      },
      {
        sessionId: sessions[2].id,
        userId: admin.id,
        commentText:
          "J’adore le côté écrit + guidé. Lorem ipsum dolor sit amet.",
      },
    ],
  });

    ...
    <div className="bg-[#e8e0f0] min-h-screen font-nunito text-[#2A2340]">
      ...
      <main className="max-w-6xl mx-auto px-6 py-16 space-y-20">
        ...
        <section>
          ...
          <div className="bg-white rounded-2xl pt-8 px-8 pb-14 border border-purple-100 border-b-4 border-b-[#bb99f4] shadow-[0_4px_0_0_#bb99f4] group-hover:shadow-none relative group overflow-hidden">
          <ul className="space-y-6 text-sm md:text-base leading-relaxed list-disc list-inside marker:text-purple-300 transition-transform duration-300 ease-out group-hover:translate-y-3">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Kits", image: "/image_about_svg/Frame_3645.svg", text: "Des coffrets bien-être personnalisés pour transformer chaque instant en rituel de sérénité." },
              { title: "Accessoires", image: "/image_about_svg/Frame_3646.svg", text: "Des accessoires et objets aussi utiles qu'élégants pour apaiser l'esprit et embellir le quotidien." },
              { title: "Coaching", image: "/image_about_svg/Frame_3649.svg", text: "Un accompagnement inspirant (Pilates, respiration, conseils) pour progresser en douceur." },
              { title: "Abonnement", image: "/image_about_svg/Frame_3647.svg", text: "Un espace digital exclusif avec un suivi et un accompagnement programmé pour prendre soin de soi chaque jour." }
            ].map((item, idx) => (

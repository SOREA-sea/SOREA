...
const categoriesData = {
  "bien-etre": {
    taches: [
      ...
      { title: "L'Action", text: "Réalise un rêve que tu repousses depuis longtemps (commence par un petit pas)" },
      ...
      { title: "Vision", text: "Compléter la phrase : J'aimerai que les autres sachent que..." },
      { title: "Libération", text: "Réécris une croyance limitante puis sa version libératrice" },
    ],
    images: [
      ...
      { url: "/image_wheel/light-bulb 1.svg", rotationCarte: 144 },
      { url: "/image_wheel/sun 1.svg", rotationCarte: 108 },
      { url: "/image_wheel/notebook 1.svg", rotationCarte: 72 },
      { url: "/image_wheel/mirror 1.png", rotationCarte: 36 },
      { url: "/image_wheel/dna 1.svg", rotationCarte: 0 },
    ]
  },
  "nutrition": {
    taches: [
      { title: "Défi Nutrition", text: "Boire un grand verre d'eau" },
      { title: "Défi Nutrition", text: "Manger un fruit de saison" },
      { title: "Défi Nutrition", text: "Cuisiner un repas 100% maison" },
      { title: "Défi Nutrition", text: "Remplacer un snack par des amandes" },
      { title: "Défi Nutrition", text: "Prendre le temps de mâcher lentement" },
      { title: "Défi Nutrition", text: "Tester un nouveau légume" },
      { title: "Défi Nutrition", text: "Boire un thé vert ou une tisane" },
      { title: "Défi Nutrition", text: "Ne pas ajouter de sel aujourd'hui" },
      { title: "Défi Nutrition", text: "Manger loin des écrans" },
      { title: "Défi Nutrition", text: "Préparer un smoothie vitaminé" },
    ],
    images: [
      { url: "/image_wheel/hearts 1.svg", rotationCarte: -36 },
      { url: "/image_wheel/lotus 1.svg", rotationCarte: -72 },
  ...
  "sport": {
    taches: [
      { title: "Défi Sport", text: "Faire 15 squats" },
      { title: "Défi Sport", text: "Tenir 30 secondes en gainage" },
      { title: "Défi Sport", text: "Aller marcher 15 minutes" },
      { title: "Défi Sport", text: "Faire 10 pompes (même sur les genoux)" },
      { title: "Défi Sport", text: "Faire 20 jumping jacks" },
      { title: "Défi Sport", text: "Prendre les escaliers toute la journée" },
      { title: "Défi Sport", text: "S'étirer pendant 5 minutes" },
      { title: "Défi Sport", text: "Faire une séance de yoga courte" },
      { title: "Défi Sport", text: "Faire 10 fentes de chaque côté" },
      { title: "Défi Sport", text: "Courir ou trottiner 10 minutes" },
    ],
    images: [
      { url: "/image_wheel/hearts 1.svg", rotationCarte: -36 },
      { url: "/image_wheel/lotus 1.svg", rotationCarte: -72 },
